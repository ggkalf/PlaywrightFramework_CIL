...
test('Test participation history page', async ({ page }) => {
    ...
    // Go to dbg participation history
    await page.goto('account/profile/games/dbg-participation-history');
    const name2 = await page.innerText('#il-web-app > div.exc-container.exc-container__body.exc-container--with-bottom-margin.account-container > div > section > div.exc-content > div.account-page > h1');
    expect(name2).toBe('Draw Games')
